...
namespace hawkeye.StactStuff
{
    ...
    public class SparkRender
    {
        ...
        public SparkRender()
        {
            _viewFolder = new EmbeddedViewFolder(typeof (SparkRender).Assembly, "hawkeye.views");
        ...
        public string Render(string template, ValidationVote[] votes, HawkeyeInformation info)
        {
    ...
    public class HealthModel
    {
        ...
        public HawkeyeInformation Information { get; set; }
    }
}